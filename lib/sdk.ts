...
export const DASHBOARD_ID = "gcheck-paragon";
export const DASHBOARD_NAME = "Paragon — Governance Pre-Screen";
...
function initSdk(): DashboardClientSdk {
  // Next renders client components on the server too. There is no window and
  // no host there, so the no-op stands in for the prerender; the browser
  // bundle evaluates this module again and creates the real client at import
  // time, which is what puts the message listener up before React mounts.
